...
class English:
    ...
    def __init__(self):
        ...
        self.msg_d_gps_time_updated = 'Done - GPS Time Update'
...
class Hungarian:
    ...
    def __init__(self):
        ...
        self.msg_d_gps_time_updated = 'Kesz - GPS-idofrissites'
        self.msg_d_timestamp = '{} 20{} UTC'  #{hh:mm} 20{YY-MM-DD} UTC
        self.msg_s_tracker = 'Tracker         '
        ...
        self.msg_d_wrong_card = 'Rossz kartya az utazas befejezesehez!'
